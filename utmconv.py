...
from Simplify import coordconvert
...
# * Inputs:
# *    phi - Latitude of the point, in radians.
# *    lambda0 - Longitude of the point, in radians.
# *    lambda1 - Longitude of the central meridian to be used, in radians.
# *
# * Outputs:
...
def map_xy2latlon(x, y, lambda0):
    # double phif, Nf, Nfpow, nuf2, ep2, tf, tf2, tf4, cf; , WGS84Corr &philambda
    ...
    # /* Calculate longitude */
    lng = lambda0 + x1frac * x + x3frac * x3poly * pow(x, 3.0) + x5frac * x5poly * pow(x, 5.0) + x7frac * x7poly * pow(x, 7.0)
